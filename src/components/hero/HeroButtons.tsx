...
const HeroButtons: React.FC = () => {
  ...
  const buttonClasses = theme === "light" 
    ? "border-devops-accent1/50 hover:bg-devops-accent1/20 hover:border-devops-accent1/90"
    : "border-devops-highlight/50 hover:bg-devops-highlight/20 hover:border-devops-highlight/90";
